...
new_frontend="/opt/personal-site/frontend-v6-${release}"

mkdir -p "$new_frontend"
tar -xzf /tmp/personal-site-frontend-v6.tar.gz -C "$new_frontend"
...
install -o personalsite -g personalsite -m 0644 /tmp/personal-site-backend-v6.jar /opt/personal-site/backend/app.jar
