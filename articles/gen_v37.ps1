...
$v37Path = "C:\Users\1\Desktop\design\backend\src\main\resources\db\migration\V37__human_rewrite_articles.sql"
...
Get-ChildItem "$rewrittenDir\*.md" | Sort-Object Name | ForEach-Object {
  $slug = $_.BaseName
...
[System.IO.File]::WriteAllText($v37Path, $sb.ToString(), $utf8)
Write-Output "V37 rewritten OK, updates: $((Get-ChildItem "$rewrittenDir\*.md").Count)"
